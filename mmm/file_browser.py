...
class FileBrowserPanel(Gtk.Box):
    def __init__(self, *args, **kwargs):
        ...
        self.details_vbox.append(Gtk.Label(label='Title: ', halign=Gtk.Align.START))
        self.details_vbox.append(Gtk.Label(label='Year: ', halign=Gtk.Align.START))
        self.details_vbox.append(Gtk.Label(label='Rating: ', halign=Gtk.Align.START))
        ...
        def open_dialog_open_callback(source_object, result, _data):
            try:
                ...
                if gio_file is not None:
                    ...
                    video_file_data = load_video_file_data(gio_file.get_path())
