...
#
# Dependencies:
#   https://gnome.pages.gitlab.gnome.org/pygobject/getting_started.html#ubuntu-getting-started
#   sudo apt install libcairo2-dev pkg-config python3-dev libgirepository1.0-dev gcc gir1.2-gtk-4.0
...
class MainWindow(Gtk.ApplicationWindow):
    ...
    def on_add_button_clicked(self, button):
        ...
        self.listview.scroll_to(self.stringlist.get_n_items() - 1,
