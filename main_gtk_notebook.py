...
class MainWindow(Gtk.ApplicationWindow):
    ...
    def open_dialog_open_callback(self, dialog, result):
        ...
        #         self.list_store_model.append(MyListModelDataItem(video_file.imdb_name or video_file.scrubbed_file_name, video_file.imdb_year or video_file.scrubbed_file_year, video_file.imdb_rating, video_file.imdb_tt))
